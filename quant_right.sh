CUDA_VISIBLE_DEVICES=5 python autogpt8k.py --num_calibrations 1 --dataset all_recite --only_quantize_mlp --use_rtn \
 --device_num 1 --batch_size 1 --quantized_model_dir  /disk1/model/AutoGPTQ/Qwen3-30Ba3-Instruct-mlp-rtn-fp4-fake


# CUDA_VISIBLE_DEVICES=5 python autogpt8k.py --num_calibrations 4096 --dataset others --only_quantize_mlp  \
#  --device_num 1 --batch_size 1 --quantized_model_dir  /disk1/model/AutoGPTQ/Qwen3-30Ba3-Instruct-others-4096-1104
