...
def get_calibration_data_gptq(data_path = "/disk1/model/newgptq/30b_calibration.json", pretrained_model_dir=None, num_calibrations=8192, max_length=4096, use_shuffle=True):
